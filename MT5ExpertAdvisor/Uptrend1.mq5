...
int OnInit()
  {   
   ...
   MA_handle = iMA(NULL, PERIOD_M1, 2, 0, MODE_SMA, PRICE_CLOSE);
   if(MA_handle < 0)
     {
   ...
   MA_handle2 = iMA(NULL, PERIOD_M1, 5, 0, MODE_SMA, PRICE_CLOSE);
   if(MA_handle2 < 0)
     {
   ...
   MA_handle3 = iMA(NULL, PERIOD_M1, 5, 0, MODE_SMA, PRICE_OPEN);
   if(MA_handle3 < 0)
     {
   ...
   MA_handle4 = iMA(NULL, PERIOD_M1, 2, 0, MODE_SMA, PRICE_OPEN);
   if(MA_handle4 < 0)
     {
   ...
   for(int i = limit-1; i >= 0; i--)
     {
      ...
      //Indicator Buffer 1
      if(MA[barshift_M1[i]] > MA2[barshift_M1[i]] //Moving Average > Moving Average
      && MA3[barshift_M1[i]] > MA4[barshift_M1[i]] //Moving Average > Moving Average
      )
        {
